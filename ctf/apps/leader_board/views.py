...
class Home(TemplateView):
    template_name = "leader_board/home.html"
...
class LeaderBoard(TemplateView):
    template_name = 'leader_board/leaderboard.html'
...
class Flag(TemplateView):
    template_name = 'leader_board/flag.html'
...
class Challenges(TemplateView):
    template_name = 'leader_board/challenges.html'
